...
// 1 融景餐厅
    function rongJing() {
    var myChart = echarts.init(document.getElementById('rongJing'));
...
// 金茂酒店
    function jinMao() {
    var myChart = echarts.init(document.getElementById('jinMao'));
...
// 古堡餐厅
      function guBao() {
    var myChart = echarts.init(document.getElementById('guBao'));
